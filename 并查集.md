...
![image-20210106211112265](/image-20210106211112265.png)
...
![image-20210106212242208](/image-20210106212242208.png)
...
![image-20210106213003196](/image-20210106213003196.png)
...
![image-20210106213700913](/image-20210106213700913.png)
...
构造函数初始化数据结构需要 O(N) 的时间和空间复杂度；连通两个节点 union 、判断两个节点的连通 性 connected 、计算连通分量 count 所需的时间复杂度均为 O(1)。